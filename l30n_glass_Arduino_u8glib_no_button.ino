...
byte iMonth = 1;
byte iDay = 1;
byte iWeek = 1;    // 1: 星期日, 星期1, 星期2, 星期3, 星期4, 星期5,星期6
byte iAmPm = 0;    // 0:上午, 1:下午
byte iHour = 0;
byte iMinutes = 0;
byte iSecond = 0;
...
PROGMEM const char* const weekString[] = {"", "星期日", "星期1", "星期2", "星期3", "星期4", "星期5", "星期6"};
PROGMEM const char* const ampmString[] = {"上午", "下午"};
///////////////////////////////////////////////////////////////////
...
PROGMEM const char* const strIntro[] = {"LEON", "GLASS", "Arduino v1.0"};
///////////////////////////////////////////////////////////////////
...
void setup()   {
  ...
  Serial.println(F("LEONGLASS v1.0 u8g"));
...
void setTimeValue() {
  iMonth = timeBuffer[0];
  iDay = timeBuffer[1];
  iWeek = timeBuffer[2];    // 1: 星期日, 星期1, 星期2, 星期3, 星期4, 星期5,星期6
  iAmPm = timeBuffer[3];    // 0:上午, 1:下午
  iHour = timeBuffer[4];
